    ...
    <footer id="contact" class="bg-secondary-dark py-12">
      <div class="container mx-auto px-4">
        <div class="grid md:grid-cols-3 gap-8 mb-8">
          <!-- About -->
          <div>
            <h3 class="text-white font-bold text-lg mb-4">Mazuba Envirotech LTD</h3>
          ...
          <!-- Quick Links -->
          <div>
            <h4 class="text-primary font-semibold mb-4">Quick Links</h4>
          ...
          <!-- Contact -->
          <div>
            <h4 class="text-primary font-semibold mb-4">Contact Us</h4>
            <div class="space-y-3 text-white/70 text-sm">
              ...
              <div class="flex items-start gap-3">
                <svg class="w-4 h-4 text-accent mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="border-t border-white/20 pt-6 text-center">
          <p class="text-white/50 text-sm">
            &copy; <?= date('Y') ?> Connect Tech And Marketing Agency. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
